...
let arrayTransacaoEX15 = [
    transacao0 = {  tipo : "entrada",   valor : 236.69},
    transacao1 = {  tipo : "saida",   valor : 131.22},
    transacao2 = {  tipo : "saida",   valor : 86.99},
    transacao3 = {  tipo : "entrada",   valor : 51.20},
    transacao4 = {  tipo : "saida",   valor : 92.12},
    transacao5 = {  tipo : "entrada",   valor : 34.66},
];
let saldoTotalEX15 = 0;

arrayTransacaoEX15.forEach(transacao => {
    if (transacao.tipo === "entrada") {
        saldoTotalEX15 += transacao.valor;
    }else {
        saldoTotalEX15 -= transacao.valor;
    }
});
console.log(`O saldo total após todas as transações é: R$ ${saldoTotalEX15.toFixed(2)}`);